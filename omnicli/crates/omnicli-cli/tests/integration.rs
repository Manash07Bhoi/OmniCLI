...
fn test_hash_and_compare_pipeline() {
    use omnicli_core::hash::{hash_bytes, HashAlgo};
    use omnicli_file::compare::compare_files;
    use omnicli_file::copy_move::{copy_path, CopyOptions};
...
fn test_conversion_chain_csv_json_yaml() {
    use omnicli_convert::codec::convert;
...
fn test_archive_tar_gz_roundtrip() {
    use omnicli_archive::{create_archive, extract_archive};
...
fn test_archive_convert_zip_to_tar_gz() {
    use omnicli_archive::create::create_archive as ca;
    use omnicli_archive::{create_archive, extract_archive};
...
fn test_encrypt_decrypt_roundtrip() {
    ...
    use omnicli_file::{decrypt::decrypt_file, encrypt::encrypt_file};
...
fn test_search_index_and_query() {
    use omnicli_search::search::ContentFilter;
    use omnicli_search::{open_index_db, rebuild_index, search_query, SearchOptions};
...
fn test_find_files_by_pattern() {
    use omnicli_file::find::{find_files, EntryType, FindOptions};
...
fn test_duplicate_detection() {
    use omnicli_file::duplicate::scan_duplicates;
...
fn test_list_supported_pairs_complete() {
    let pairs = omnicli_convert::codec::list_supported_pairs();
